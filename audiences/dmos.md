...
::card-group{cols=2}
  ...
  ::card{title="Relationships" icon="ph:handshake"}
  You work with operators continuously. You spot changes before anyone else.
  ::

  ::card{title="Quality standards" icon="ph:seal-check"}
  You maintain standards and hold venues accountable.
  ::

  ::card{title="Destination story" icon="ph:book-open"}
...
::steps
  ...
  ::step{title="Design verification"}
...
All Curators commit to transparency and accuracy. See the [full manifesto](/reference/curator-manifesto).
