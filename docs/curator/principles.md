...
- **Open Standards** — The specifications remain open and implementable by anyone.
- **Published Criteria** — Curation criteria are published, not hidden.
- **Competition** — Alternative Curators can emerge and compete.
- **Correction Paths** — Venues can challenge incorrect information.
